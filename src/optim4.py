...
def costFunc(x,df,i2s):
    ...
    M=np.matrix([[k[0], m[0],m[1]],[m[2], k[1],m[3]],[m[4],m[5],k[2]]])
...
if __name__ == '__main__':
    ...
    bias0=[-0.52538004,  0.05435033, -0.55229391] #arcsec
    m0=[ 0.00061759, -0.0036177,  -0.00061772,  0.00806855,  0.00358465, -0.00816267]
    k0=[ 0.95178648,  1.01545105,  0.93254936]
    x0=k0+m0+bias0
    ...
    print xopt
    a=1
#    k: [ 0.95178648  1.01545105  0.93254936] m: [ 0.00061759 -0.0036177  -0.00061772  0.00806855  0.00358465 -0.00816267] Bias: [-0.52538004  0.05435033 -0.55229391]  Cost: 8.73926592141e-07
