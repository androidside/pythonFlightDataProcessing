...
detMapfile='C:/Users/bettii/Desktop/det_map.txt' #detMap txt file describing the relation between row,col fields to vert,horiz pixels

#Dictionary mapping every field to a (vertical pixel, horizontal pixel, detectorId)
...
#Mapping of each detectorId number to the detector name
detId={
    0:'C',
    1:'A',
    2:'B',
