...
from utils.dataset import plotQuaternions,plotColumns,plotCovs
...
if __name__ == '__main__':
    ...
    if not estimated:
        ...
        Qd[3:6,3:6]=1e-6**2*dt*np.eye(3) #k
        Qd[6:12,6:12]=1e-6**2*dt*np.eye(6) #m
        Qd[12:15,12:15]=(4.848e-6*1e-30)**2*dt*np.eye(3) #bias
